...
- Updated `keras` from 3.12.0 to 3.13.1
  - Fixed resource allocation without limits vulnerability in HDF5 weight loading component
  - Prevents potential DoS attacks via malicious HDF5 files
